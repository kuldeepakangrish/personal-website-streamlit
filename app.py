...
with st.container():
    ...
    with left_column:
        ...
        st.markdown('<iframe width="300" height="150" src="https://www.youtube.com/watch?v=HNk293pQTHo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>', unsafe_allow_html=True)        
